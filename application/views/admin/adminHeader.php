...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?=site_url('track/dashboard')?>"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Student</a></li>
			<li><a href="<?=site_url('track/employee')?>"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Employee</a></li>
		</ul>
